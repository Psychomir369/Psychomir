# این ماژول شامل منطق مربوط به ورود، خروج، ثبت‌نام، ورود با شماره تلفن، تأیید کد، و به‌روزرسانی اطلاعات کاربران است
# همچنین شامل توابعی برای ارسال پیامک تأیید و مدیریت تغییرات کاربری می‌باشد
...
# عملیات ورود کاربر با نام کاربری و رمز عبور
...
# ورود کاربر با شماره تلفن و ارسال کد تأیید
...
# به‌روزرسانی اطلاعات اضافی کاربر
